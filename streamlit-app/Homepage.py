...
with st.container():
    ...
    st.markdown("<p stype=''><h5 style='text-decoration: underline;'>CẢM HỨNG: </h5>Sau nhiều tuần trăn trở về ý tưởng chính của dự án, nhóm đã quyết định làm A.I về nhận dạng chữ cái cũng như chữ số. <b style='color: #FFFFE0; font-style: italic;'>Lấy cảm hứng từ dataset MNIST</b> mà cả nhóm đã quá quen thuộc sau nhiều bài Homework, nhóm đã tìm, cũng như tự tạo một dataset bao gồm các số từ 0-9 cũng như 26 chữ của Bảng chữ cái Tiếng Anh, cả chữ hoa và thường.</p>", unsafe_allow_html=True)
